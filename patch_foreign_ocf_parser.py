...
OLD_CASH_FLOW = '''    extracted = _extract_metric_from_candidates(\n        candidates,\n        "operating_cash_flow",\n    )\n'''

NEW_CASH_FLOW = '''    extracted = _extract_metric_from_candidates(\n        candidates,\n        "operating_cash_flow",\n        document_period_hint=document_period_hint,\n    )\n'''
...
def main() -> None:
    ...
    text = replace_once(text, OLD_CASH_FLOW, NEW_CASH_FLOW, "cash-flow candidate lookup")
