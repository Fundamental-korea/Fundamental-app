...
OLD_QUARTER_CALL = '''        "quarter": _normalized_cash_flow_period(\n            candidates,\n            "quarter",\n        ),'''
NEW_QUARTER_CALL = '''        "quarter": _normalized_cash_flow_period(\n            candidates,\n            "quarter",\n            document_period_hint=document_period_hint,\n        ),'''
OLD_YTD_CALL = '''        "ytd": _normalized_cash_flow_period(\n            candidates,\n            "ytd",\n        ),'''
NEW_YTD_CALL = '''        "ytd": _normalized_cash_flow_period(\n            candidates,\n            "ytd",\n            document_period_hint=document_period_hint,\n        ),'''
OLD_ANNUAL_CALL = '''        "annual": _normalized_cash_flow_period(\n            candidates,\n            "annual",\n        ),'''
NEW_ANNUAL_CALL = '''        "annual": _normalized_cash_flow_period(\n            candidates,\n            "annual",\n            document_period_hint=document_period_hint,\n        ),'''
...
def main() -> None:
    ...
    text = replace_once(text, OLD_QUARTER_CALL, NEW_QUARTER_CALL, "quarter cash-flow call")
    text = replace_once(text, OLD_YTD_CALL, NEW_YTD_CALL, "YTD cash-flow call")
    text = replace_once(text, OLD_ANNUAL_CALL, NEW_ANNUAL_CALL, "annual cash-flow call")
